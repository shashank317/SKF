/**
 * Lubrication System Parameters - RainSystem AF 150-2
...
export const PARAMETERS = {
    ...
    BED_WIDTH: {
        ...
        step: 0.1,
        step: 'hydraulics',
        description: 'Scale factor for tank width'
    },
    BED_HEIGHT: {
        label: 'Bed Height (scale)',
        key: 'BED_HEIGHT',
        type: 'number',
        input: 'number',
        defaultValue: 1,
        ...
        step: 0.1,
        step: 'hydraulics',
        description: 'Scale factor for tank height'
    },
