...
OUTPUT_PATH = r"C:\\Users\\sumit\\OneDrive\\Desktop\\projects\\SKF\\SKF\\backend\\exports\\custom_model_379341ca.glb"
OUTPUT_FORMAT = "glb"
...
def create_stepped_revolution():
    ...
    segments = [
        (V(0,     0,    0), V(0,     21.8, 0)),
        (V(0,     21.8, 0), V(24.5,  21.8, 0)),
        (V(24.5,  21.8, 0), V(24.5,  50.0, 0)),
        (V(24.5,  50.0, 0), V(44.5,  50.0, 0)),
        (V(44.5,  50.0, 0), V(44.5,  45.0, 0)),
        (V(44.5,  45.0, 0), V(49.5,  45.0, 0)),
        (V(49.5,  45.0, 0), V(49.5,  40.0, 0)),
        (V(49.5,  40.0, 0), V(54.5,  40.0, 0)),
        (V(54.5,  40.0, 0), V(54.5,  16.8, 0)),
        (V(54.5,  16.8, 0), V(0,     16.8, 0)),
        (V(0,     16.8, 0), V(0,     0,    0)),
    ]
    ...
    sketch.addConstraint(Sketcher.Constraint('DistanceY', -1, 1, 1, 1, 21.8))
    ...
    sketch.addConstraint(Sketcher.Constraint('DistanceY', -1, 1, 7, 1, 40.0))
    sketch.addConstraint(Sketcher.Constraint('DistanceY', -1, 1, 9, 1, 16.8))

    sketch.addConstraint(Sketcher.Constraint('DistanceX', -1, 1, 1, 2, 24.5))
    sketch.addConstraint(Sketcher.Constraint('DistanceX', -1, 1, 3, 2, 44.5))
    sketch.addConstraint(Sketcher.Constraint('DistanceX', -1, 1, 5, 2, 49.5))
    sketch.addConstraint(Sketcher.Constraint('DistanceX', -1, 1, 7, 2, 54.5))
